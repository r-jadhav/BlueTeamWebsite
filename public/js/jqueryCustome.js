...
function initSlickCarousel() {
	...
	jQuery('.bannerSlide').slick({
		...
		slidesToScroll: 1,
		dots: false,
		prevArrow: '<a href="#" class="slickPrev d-flex align-items-center"><span class="sr-only">Previous slide</span></a>',
		nextArrow: '<a href="#" class="slickNext d-flex align-items-center"><span class="sr-only">Next slide</span></a>',
		autoplay: true,
		arrows: true,
		speed: 1000,
		responsive: [{
	...
	jQuery('.SpecializedSlider').slick({
		slidesToShow: 3,
		slidesToScroll: 1,
		dots: true,
		autoplay: true,
	...
	jQuery('.awardSlider').slick({
		...
		slidesToScroll: 1,
		dots: false,
		prevArrow: '<a href="#" class="slickPrev fas fa-chevron-left d-flex align-items-center"><span class="sr-only">Previous slide</span></a>',
		nextArrow: '<a href="#" class="slickNext fas fa-chevron-right d-flex align-items-center"><span class="sr-only">Next slide</span></a>',
		autoplay: true,
		speed: 1000,
		arrows: true,
		responsive: [
...
function initStickyScrollBlock() {
	jQuery('.menuHolder, .menuLHolder').stickyScrollBlock({
		setBoxHeight: true,
