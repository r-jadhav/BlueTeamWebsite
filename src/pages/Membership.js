...
<section class="faqWrapSec cwsSec pt-12 pt-md-15 pt-lg-17 pt-xl-19">
        <div class="container">
          <div class="row">
    	...
    	<section class="pb-9 ">
				<div class="container">
					{/* <div class="row">
						<div class="col-12 col-md-4">
							<div class="cofBlock bd-white text-center float-md-right mx-auto mr-md-1 ml-md-0 mb-5 mb-md-0">
								<h4 class="mb-0 headingX py-4">
									<strong class="d-block font-weight-normal text-capitalize mb-2">Silver card ( 180 )</strong>
									<strong class="headingII d-block font-weight-bold text-primary mb-2">Save 20</strong>
									<strong class="d-block dtlservice font-weight-normal mb-1">Pay 180 and your balance will be 200!</strong>
									<strong class="d-block dtlservice font-weight-normal mb-1">Valid for all services</strong>
								</h4>
							</div>
						</div>
						...
						<div class="cofBlock bd-white text-center float-md-right mx-auto mr-md-1 ml-md-0 mb-5 mb-md-0">
								<h4 class="mb-0 headingX py-4">
									<strong class="d-block font-weight-normal text-capitalize mb-2">Silver card ( 500 ) </strong>
									<strong class="headingII d-block font-weight-bold text-primary mb-2">Save 80</strong>
									<strong class="d-block dtlservice font-weight-normal mb-1">Pay 420 and your balance will be 500!</strong>
									<strong class="d-block dtlservice font-weight-normal mb-1">Valid for all services</strong>
								</h4>
							</div>
						</div>
						...
						<div class="cofBlock bd-white text-center float-md-right mx-auto mr-md-1 ml-md-0 mb-5 mb-md-0">
								<h4 class="mb-0 headingX py-4">
									<strong class="d-block font-weight-normal text-capitalize mb-2">Silver card ( 1000 )</strong>
									<strong class="headingII d-block font-weight-bold text-primary mb-2">Save 200</strong>
									<strong class="d-block dtlservice font-weight-normal mb-1">Pay 800 and your balance will be 1000!</strong>
									<strong class="d-block dtlservice font-weight-normal mb-1">Valid for all services</strong>
								</h4>
							</div>
						</div>
